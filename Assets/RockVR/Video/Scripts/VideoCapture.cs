...
namespace RockVR.Video
{
    ...
    public class VideoCapture : VideoCaptureBase
    {
        ...
        public bool startFrameEncode = false;
        /// <summary>
        ...
        /// </summary>
        /// 
        ///  made public to get information easely /^sw
        ...
        void CopyFrameTexture()
        {
            ...
            else if (panoramaProjection != PanoramaProjectionType.CUBEMAP)
            {
